...
- **2026-06-26 — Phase 0 started.** Scaffolding `vellum-engine` repo: package.json (bun+tsup+vitest), tsconfig (strict), spindle.json, core module skeleton, `host/user` + `host/capability`, component model with error boundary, first tests.
