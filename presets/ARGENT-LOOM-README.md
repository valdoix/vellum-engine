...
2. Read the warning. Engine Pass accepts partial change-only replies and derives omitted roster/proof bookkeeping locally. ARGENT still enforces its opening plot obligations and Sandbox floors. It also rejects malformed identities, backward or contradictory time, unauthorized player state, persona-bearing subplots, unsupported deltas, unsafe knowledge transmission, and ungrounded off-screen movement or resolution.
