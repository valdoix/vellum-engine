...
export const DEFAULT_ARC_PROMPT =
  ...
  + 'detail; an arc is the shape of the story, not its every beat. The supplied chapters are evidence for this assigned '
  + 'archive task; they are not expected to contain a question. Perform the consolidation immediately instead of asking '
  + 'what the user wants done with the recap. Do NOT invent or embellish. '
  + 'Respond in EXACTLY this layout, nothing before or after:\n'
  + 'DETAIL:\n'
