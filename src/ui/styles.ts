...
`,
  ...
  ".vlv-bk-tag{font:600 9px/1 var(--vmono);text-transform:uppercase;color:var(--v-info);opacity:.7}.vlv-bk-tag.vault{color:var(--v-pos-i);opacity:1}.vlv-bk-tag.protected{color:var(--v-warn)}",
