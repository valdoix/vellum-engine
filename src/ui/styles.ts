...
const SHAPE_GEOM: Record<string, string> = {
  ...
  'rococo-cameo': 'border-radius:48%/24%;padding:20px 19px 16px',
  ...
  'candy-capsule': 'border-radius:999px;padding:21px 22px',
  ...
  'quilt-locket': 'border-radius:50%/26%;padding:23px 20px 19px',
...
.vle-vg-title button{float:right;font:inherit;font-size:11px}.vle-vr small[data-dependency-note]{display:block;color:var(--vle-warn,#b77925);margin-top:4px}.vle-vr[hidden]{display:none!important}`,
  ...
  "html[data-vle-chrome='rococo'] .vle-root{font-family:var(--vserif);background-image:radial-gradient(circle at 14% 9%,color-mix(in srgb,var(--vg) 14%,transparent),transparent 19%),radial-gradient(circle at 86% 16%,color-mix(in srgb,var(--v-pos) 13%,transparent),transparent 23%)}",
  "html[data-vle-chrome='rococo'] .vle-navpanel{border:3px double color-mix(in srgb,var(--vg) 72%,transparent);border-radius:42px 12px 42px 12px;background:linear-gradient(145deg,color-mix(in srgb,var(--vg) 10%,var(--vsurf-1)),color-mix(in srgb,var(--v-pos) 9%,var(--vsurf-2)));box-shadow:inset 0 0 0 6px color-mix(in srgb,var(--vg) 5%,transparent),0 18px 34px rgba(0,0,0,.25)}",
  ...
  "html[data-vle-chrome='rococo'][data-shape-cast='rococo-cameo'] .vle-card:not(.vle-fac){background:radial-gradient(ellipse at 50% 20%,color-mix(in srgb,var(--v-info) 18%,var(--vsurf-1)),var(--vsurf-2) 76%)}",
  ...
  "html[data-vle-chrome='candy'] .vle-root{font-family:var(--vserif);background-image:radial-gradient(circle at 12px 12px,color-mix(in srgb,var(--v-pos) 20%,transparent) 0 1px,transparent 2px),linear-gradient(color-mix(in srgb,var(--v-info) 6%,transparent) 1px,transparent 1px),linear-gradient(90deg,color-mix(in srgb,var(--vg) 6%,transparent) 1px,transparent 1px);background-size:24px 24px,32px 32px,32px 32px}",
  ...
  "html[data-vle-chrome='candy'] .vle-card,html[data-vle-chrome='candy'] .vle-rel-card,html[data-vle-chrome='candy'] .vld-sec,html[data-vle-chrome='candy'] .vld-pc,html[data-vle-chrome='candy'] .vle-item-row{position:relative;text-align:left;border-color:var(--v-info);background:linear-gradient(145deg,color-mix(in srgb,var(--vg) 10%,var(--vsurf-1)),color-mix(in srgb,var(--v-info) 7%,var(--vsurf-2)));box-shadow:inset 0 0 16px color-mix(in srgb,var(--vg) 7%,transparent),0 0 13px color-mix(in srgb,var(--v-info) 25%,transparent),0 10px 24px rgba(0,0,0,.32)}",
  ...
  "html[data-vle-chrome='candy'] .v-chip{border-radius:999px;border-color:var(--v-pos);box-shadow:inset 0 0 8px color-mix(in srgb,var(--v-pos) 12%,transparent)}",
  ...
  "html[data-vle-chrome='candy'][data-shape-cast='candy-capsule'] .vle-card:not(.vle-fac){border-color:var(--vg);background:linear-gradient(110deg,color-mix(in srgb,var(--vg) 17%,var(--vsurf-1)) 0 49%,color-mix(in srgb,var(--v-info) 16%,var(--vsurf-2)) 51%)}",
  ...
  "html[data-vle-chrome='quilt'] .vle-root{font-family:var(--vserif);background-image:repeating-linear-gradient(45deg,color-mix(in srgb,var(--vg) 7%,transparent) 0 18px,color-mix(in srgb,var(--v-pos) 7%,transparent) 18px 36px,color-mix(in srgb,var(--v-info) 7%,transparent) 36px 54px,color-mix(in srgb,var(--v-warn) 7%,transparent) 54px 72px);background-size:102px 102px}",
  "html[data-vle-chrome='quilt'] .vle-navpanel{border:2px dashed color-mix(in srgb,var(--v-warn) 75%,transparent);border-radius:24px 9px 28px 12px;background:linear-gradient(145deg,color-mix(in srgb,var(--vg) 10%,var(--vsurf-1)),color-mix(in srgb,var(--v-info) 8%,var(--vsurf-2)));box-shadow:inset 0 0 0 5px color-mix(in srgb,var(--v-pos) 8%,transparent),0 18px 36px rgba(0,0,0,.28)}",
  ...
  "html[data-vle-chrome='quilt'][data-shape-cast='quilt-locket'] .vle-card:not(.vle-fac){border-color:var(--v-warn);background:radial-gradient(ellipse at 50% 18%,color-mix(in srgb,var(--v-info) 19%,var(--vsurf-1)),var(--vsurf-2) 74%)}",
  ...
  ...shapeDetail('candy-capsule', "content:'';position:absolute;top:5px;bottom:5px;left:50%;width:2px;pointer-events:none;z-index:1;background:linear-gradient(var(--vg),var(--v-info));box-shadow:0 0 9px color-mix(in srgb,var(--vg) 55%,transparent);opacity:.66", '::before'),
  ...
  ...shapeDetail('quilt-locket', "content:'';position:absolute;inset:6px 10px;pointer-events:none;z-index:1;border:2px dashed color-mix(in srgb,var(--v-warn) 60%,transparent);border-radius:50%/27%;background:radial-gradient(circle 3px at 50% 8px,var(--vg) 92%,transparent);opacity:.72", '::before'),
