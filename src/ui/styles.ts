...
export const STYLES = [
  ...
  ".vle-m-arc{display:flex;gap:0;margin-bottom:0.7rem;border-radius:8px;overflow:hidden;border:1px solid var(--vle-keyline);background:linear-gradient(135deg,color-mix(in srgb,var(--vg) 8%,transparent),color-mix(in srgb,var(--vsurf-2) 55%,transparent));transition:border-color .18s,box-shadow .18s}",
  ".vle-m-arc:hover{border-color:var(--vle-keyline-strong);box-shadow:0 6px 22px rgba(0,0,0,0.35)}",
  ".vle-m-arc.done{opacity:0.52}",
  ".vle-m-arc-bar{width:5px;flex-shrink:0;background:linear-gradient(180deg,var(--vle-gold-bright),var(--vle-gold-dim))}",
  ".vle-m-arc.done .vle-m-arc-bar{background:var(--vle-gold-dim);opacity:0.5}",
  ".vle-m-arc-body{flex:1;padding:0.95rem 1.1rem}",
  ".vle-m-arc-head{display:flex;justify-content:space-between;align-items:baseline;margin-bottom:0.5rem}",
  ".vle-m-arc-tier{font-family:var(--mono);font-size:0.58rem;letter-spacing:0.16em;text-transform:uppercase;color:var(--vg);background:color-mix(in srgb,var(--vg) 13%,transparent);border:1px solid color-mix(in srgb,var(--vg) 25%,transparent);border-radius:3px;padding:1px 7px}",
  ".vle-m-arc-span{font-family:var(--mono);font-size:0.62rem;color:var(--vink-faint);letter-spacing:0.05em}",
  ".vle-m-arc-text{font-size:0.95rem;color:var(--vink-dim);line-height:1.6;margin-bottom:0.75rem}",
  ".vle-m-arc-foot{display:flex;justify-content:space-between;align-items:center}",
  ".vle-m-arc-covers{font-family:var(--mono);font-size:0.6rem;color:var(--vink-faint);letter-spacing:0.05em}",
  // MEMORY — Chapter cards
  ".vle-m-chap{border-radius:8px;border:1px solid var(--vle-keyline);overflow:hidden;background:var(--vsurf-2);margin-bottom:0.55rem;transition:border-color .15s}",
  ".vle-m-chap:hover{border-color:var(--vle-keyline-strong)}",
  ".vle-m-chap-head{display:flex;align-items:center;gap:0.6rem;padding:0.8rem 1rem;cursor:pointer;user-select:none}",
  ".vle-m-chap-chev{color:var(--vle-gold-dim);font-size:0.62rem;transition:transform .18s;flex-shrink:0}",
  ".vle-m-chap.open .vle-m-chap-chev{transform:rotate(90deg);color:var(--vg)}",
  ".vle-m-chap-tw{flex:1;display:flex;align-items:baseline;gap:0.6rem;min-width:0}",
  ".vle-m-chap-tier{font-family:var(--mono);font-size:0.56rem;letter-spacing:0.12em;text-transform:uppercase;color:var(--vink-faint);background:color-mix(in srgb,var(--vg) 7%,transparent);border:1px solid var(--vle-keyline);border-radius:3px;padding:1px 6px;flex-shrink:0}",
  ".vle-m-chap-title{font-size:0.97rem;color:var(--vink);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
  ".vle-m-chap-span{font-family:var(--mono);font-size:0.6rem;color:var(--vink-faint);flex-shrink:0;margin-left:auto}",
  ".vle-m-chap-body{display:none;padding:0 1rem 1rem;border-top:1px solid var(--vle-keyline)}",
  ".vle-m-chap.open .vle-m-chap-body{display:block}",
  ".vle-m-chap-text{font-size:0.93rem;color:var(--vink-dim);line-height:1.6;padding-top:0.75rem;margin-bottom:0.7rem}",
  ".vle-m-chap-turns{background:color-mix(in srgb,var(--vg) 4%,transparent);border:1px solid var(--vle-keyline);border-radius:6px;padding:0.65rem 0.8rem}",
  ".vle-m-chap-turns-label{font-family:var(--mono);font-size:0.58rem;color:var(--vle-gold-dim);letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.5rem}",
  ".vle-m-turn-chip{font-family:var(--mono);font-size:0.65rem;color:var(--vink-faint);padding:0.22rem 0;border-bottom:1px solid color-mix(in srgb,var(--vg) 10%,transparent);line-height:1.4}",
  ".vle-m-turn-chip:last-child{border-bottom:none}",
  // MEMORY — Raw uncovered turn rows
  ".vle-m-turns-label{font-family:var(--mono);font-size:0.6rem;letter-spacing:0.14em;text-transform:uppercase;color:var(--vink-faint);margin-bottom:0.6rem;margin-top:0.8rem}",
  ".vle-m-turns-grid{display:grid;gap:0.4rem}",
  ".vle-m-turn-raw{display:flex;align-items:baseline;gap:0.6rem;background:color-mix(in srgb,var(--vg) 4%,transparent);border:1px solid var(--vle-keyline);border-radius:5px;padding:0.55rem 0.75rem;transition:border-color .15s}",
  ".vle-m-turn-raw:hover{border-color:color-mix(in srgb,var(--vg) 35%,transparent)}",
  ".vle-m-turn-raw-t{font-family:var(--mono);font-size:0.6rem;color:var(--vle-gold-dim);flex-shrink:0;letter-spacing:0.04em}",
  ".vle-m-turn-raw-x{font-size:0.9rem;color:var(--vink-faint);flex:1;line-height:1.4}",
  // KNOWLEDGE — Epistemic character cards
  ".vle-k-card{border:1px solid var(--vle-keyline);border-radius:9px;overflow:hidden;background:var(--vsurf-2);margin-bottom:0.85rem}",
  ".vle-k-card.collapsed-k{opacity:0.65}",
  ".vle-k-card-head{display:flex;align-items:center;justify-content:space-between;padding:0.7rem 1rem;border-bottom:1px solid var(--vle-keyline);background:linear-gradient(90deg,color-mix(in srgb,var(--vg) 6%,transparent),transparent)}",
  ".vle-k-card-name{font-size:1.05rem;font-weight:600;color:var(--vink);letter-spacing:0.01em}",
  ".vle-k-card-count{font-family:var(--mono);font-size:0.58rem;color:var(--vle-gold-dim);letter-spacing:0.08em;text-transform:uppercase}",
  ".vle-k-rows{padding:0.5rem 0}",
  ".vle-k-row{display:flex;align-items:baseline;gap:0.65rem;padding:0.5rem 1rem;transition:background .12s}",
  ...
  ".vle-k-rel{flex-shrink:0;width:18px;text-align:center;font-size:1rem}",
  ".vle-k-rel.knows{color:var(--vink-faint);font-size:1.2rem}",
  ".vle-k-rel.believes{color:var(--v-warn);font-size:0.8rem}",
  ".vle-k-rel.suspects{color:var(--v-warn-i);opacity:0.6;font-size:0.9rem}",
  ".vle-k-rel.irony{color:var(--v-neg-i);font-size:0.9rem}",
  ".vle-k-fact{flex:1;font-size:0.93rem;color:var(--vink-dim);line-height:1.5;min-width:0}",
  ".vle-k-irony-label{display:inline-block;font-family:var(--mono);font-size:0.58rem;letter-spacing:0.1em;text-transform:uppercase;color:var(--v-neg-i);background:color-mix(in srgb,var(--v-neg) 18%,transparent);border:1px solid color-mix(in srgb,var(--v-neg) 35%,transparent);border-radius:3px;padding:1px 6px;margin-right:0.5rem;vertical-align:middle}",
  ".vle-k-about{font-family:var(--mono);font-size:0.58rem;color:var(--vink-faint);flex-shrink:0;white-space:nowrap;letter-spacing:0.04em}",
  // SECRETS — Danger-coded sealed envelopes
  ".vle-sec-card{display:flex;border-radius:9px;overflow:hidden;border:1px solid var(--vle-keyline);margin-bottom:0.75rem;transition:border-color .18s,box-shadow .15s;position:relative}",
  ".vle-sec-card:hover{box-shadow:0 6px 20px rgba(0,0,0,0.3)}",
  ".vle-sec-danger-bar{width:4px;flex-shrink:0}",
  ...
  ".vle-sec-body{flex:1;padding:0.85rem 1rem;position:relative;overflow:hidden}",
  ".vle-sec-watermark{position:absolute;top:50%;right:1rem;transform:translateY(-50%) rotate(-12deg);font-family:var(--mono);font-size:1.8rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--v-neg);opacity:0.14;pointer-events:none;white-space:nowrap}",
  ".vle-sec-head-row{display:flex;align-items:center;gap:0.6rem;margin-bottom:0.6rem;flex-wrap:wrap}",
  ".vle-sec-keeper{font-weight:600;font-size:1rem;color:var(--vink)}",
  ".vle-sec-danger{font-family:var(--mono);font-size:0.58rem;letter-spacing:0.1em;text-transform:uppercase;padding:1px 7px;border-radius:999px;border:1px solid transparent}",
  ...
  ".vle-sec-from-label{font-family:var(--mono);font-size:0.58rem;color:var(--vink-faint);letter-spacing:0.06em}",
  ".vle-sec-from-chip{font-family:var(--mono);font-size:0.6rem;color:var(--vink-dim);background:var(--vsurf-3);border:1px solid var(--vle-keyline);border-radius:999px;padding:1px 8px}",
  ".vle-sec-text{font-size:0.92rem;color:var(--vink-dim);line-height:1.6;margin-bottom:0.65rem}",
  ".vle-sec-foot{display:flex;justify-content:space-between;align-items:center}",
  ".vle-sec-turn{font-family:var(--mono);font-size:0.58rem;color:var(--vink-faint);letter-spacing:0.05em}",
  // SCARS — Palimpsest wound cards
  ".vle-scar-group{margin-bottom:1.3rem}",
  ".vle-scar-group-head{font-family:var(--mono);font-size:0.6rem;letter-spacing:0.2em;text-transform:uppercase;color:var(--vle-gold-dim);padding:0.4rem 0;border-bottom:1px solid var(--vle-keyline);margin-bottom:0.5rem}",
  ".vle-scar-card{border-radius:9px;overflow:hidden;border:1px solid color-mix(in srgb,var(--v-neg) 28%,transparent);background:linear-gradient(160deg,color-mix(in srgb,var(--v-neg) 8%,var(--vsurf-2)),var(--vsurf-2));padding:0.9rem 1rem;position:relative;transition:border-color .15s,box-shadow .15s;margin-bottom:0.6rem}",
  ...
  ".vle-scar-card:hover{border-color:color-mix(in srgb,var(--v-neg) 50%,transparent);box-shadow:0 4px 18px rgba(0,0,0,0.3)}",
  ".vle-scar-head{display:flex;align-items:baseline;gap:0.6rem;margin-bottom:0.6rem;position:relative}",
  ".vle-scar-who{font-weight:600;font-size:1rem;color:var(--vink)}",
  ".vle-scar-turn{font-family:var(--mono);font-size:0.58rem;color:var(--vink-faint);letter-spacing:0.06em}",
  ".vle-scar-was{font-size:0.94rem;color:color-mix(in srgb,var(--vink-dim) 65%,transparent);text-decoration:line-through;text-decoration-color:color-mix(in srgb,var(--v-neg) 55%,transparent);text-decoration-thickness:1.5px;line-height:1.55;margin-bottom:0.65rem;position:relative}",
  ".vle-scar-about{display:inline-block;font-family:var(--mono);font-size:0.58rem;color:var(--vink-faint);margin-left:0.5rem;text-decoration:none}",
  ".vle-scar-divider{height:1px;background:repeating-linear-gradient(90deg,color-mix(in srgb,var(--v-neg) 35%,transparent) 0,color-mix(in srgb,var(--v-neg) 35%,transparent) 4px,transparent 4px,transparent 8px);margin-bottom:0.65rem}",
  ".vle-scar-now{font-size:0.88rem;color:var(--vink-faint);font-style:italic;line-height:1.5;position:relative}",
  ".vle-scar-now-label{display:inline-block;font-family:var(--mono);font-size:0.56rem;letter-spacing:0.1em;text-transform:uppercase;color:var(--v-neg-i);font-style:normal;background:color-mix(in srgb,var(--v-neg) 14%,transparent);border:1px solid color-mix(in srgb,var(--v-neg) 30%,transparent);border-radius:3px;padding:1px 6px;margin-right:0.5rem;vertical-align:middle}",
  // CODEX — Tag-grouped canon index
  ".vle-lore-group{margin-bottom:1.3rem}",
  ".vle-lore-group-head{font-family:var(--mono);font-size:0.6rem;letter-spacing:0.2em;text-transform:uppercase;color:var(--vle-gold-dim);padding:0.4rem 0;border-bottom:1px solid var(--vle-keyline);margin-bottom:0.5rem}",
  ".vle-lore-row{display:flex;align-items:baseline;gap:0.75rem;padding:0.5rem 0.5rem 0.5rem 1rem;border-left:2px solid color-mix(in srgb,var(--vg) 30%,transparent);margin-bottom:0.35rem;border-radius:0 5px 5px 0;transition:border-left-color .15s,background .12s}",
  ".vle-lore-row:hover{border-left-color:var(--vg);background:color-mix(in srgb,var(--vg) 4%,transparent)}",
  ".vle-lore-fact{flex:1;font-size:0.93rem;color:var(--vink-dim);line-height:1.5}",
  ".vle-lore-turn{font-family:var(--mono);font-size:0.58rem;color:var(--vink-faint);flex-shrink:0;letter-spacing:0.04em}",
