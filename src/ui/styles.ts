...
.vle-vg-title button{float:right;font:inherit;font-size:11px}.vle-vr small[data-dependency-note]{display:block;color:var(--vle-warn,#b77925);margin-top:4px}.vle-vr[hidden]{display:none!important}`,
  ...
  ".vle-sumwin{position:fixed;right:18px;bottom:18px;z-index:10001;width:min(560px,calc(100vw - 28px));max-height:min(78vh,760px);display:flex;flex-direction:column;overflow:hidden;color:var(--vle-ink,#e5dcc8);background:linear-gradient(165deg,rgba(29,25,18,.99),rgba(13,12,9,.99));border:1px solid rgba(var(--vg-rgb,205,168,78),.55);border-radius:14px;box-shadow:0 24px 75px rgba(0,0,0,.72),0 0 24px rgba(var(--vg-rgb,205,168,78),.11)}",
  ".vle-sumwin-head{display:flex;align-items:center;gap:8px;min-height:42px;padding:0 10px 0 14px;border-bottom:1px solid rgba(var(--vg-rgb,205,168,78),.22);background:rgba(var(--vg-rgb,205,168,78),.055)}",
