...
const PATHS: Record<string, string> = {
  ...
  engineevidence: '<path d="M6.5 4h10v3M6.5 20h10v-3"/><path d="M6.5 8.5c-1.5 1.6-2.4 3.4-2.4 5.3a3.9 3.9 0 0 0 7.8 0c0-1.9-.9-3.7-2.4-5.3"/><path d="M10.1 13.2l1 1.1 1.9-2.2" opacity=".85"/>',
