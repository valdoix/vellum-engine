...
describe('ARGENT strengthened invariants', () => {
  ...
  it('reaches Living World parallel gates using expanded option values', () => {
    ...
    expect(expandedBlock('arg-output-contract', { state_on: 1, state_compiler: 'inline', living_world: 'off', social: 'autonomous', politics: 'off' })).toContain('Autonomous/Sandbox MUST create at least two new delta.offscreen');
