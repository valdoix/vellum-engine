...
describe('explicit elapsed day evidence', () => {
  ...
  it('requires duration long enough to reach the proposed next-day clock', () => {
    ...
    expect(supportsDayAdvance('Narrative Day 11 begins.', 540, 1320, 9, 11)).toBe(true);
    expect(supportsDayAdvance('Narrative Day 11 begins.', 540, 1320, 15, 17)).toBe(false);
    expect(supportsDayAdvance('"Tomorrow is Narrative Day 11," she says.', 540, 1320, 9, 11)).toBe(false);
