...
describe('icon set', () => {
  ...
  const ACTIONS = ['boundaries', 'calendar', 'budget', 'tone', 'summarizer', 'enginepass', 'enginewindow', 'personastate', 'hide', 'traverse', 'offscreen', 'foldtoast', 'summarize', 'rescan', 'rebuild', 'resummarize', 'tidy', 'tidyfacts', 'export', 'exportmd', 'import', 'recover', 'clear', 'help'];
